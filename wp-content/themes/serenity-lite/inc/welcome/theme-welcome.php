...
class Serenity_Lite_Welcome {
	...
	public function __construct() {
		...
		add_action( 'admin_bar_menu', array($this, 'serenity_lite_upgrade_toolbar'), 999 );
	}
	 ...
	 */
	function serenity_lite_upgrade_toolbar( $wp_admin_bar ) {

		$args = array(
			'id'    => 'themely-upgrade-serenity',
			'title' => esc_html__('Upgrade to Serenity Pro ➡', 'serenity-lite'),
			'href'  => 'https://www.themely.com/themes/serenity/',
	...
	public function serenity_lite_welcome_screen() {
		...
		<div class="wrap about-wrap theme-welcome">
            ...
            <h1><?php esc_html_e('Welcome to Serenity Lite', 'serenity-lite'); ?> <span><?php esc_html_e('VERSION 1.1.7', 'serenity-lite'); ?></span></h1>
