<div id="getting_started" class="serenity-tab-pane">
    <div class="left">
        <div>
            ...
            <ol>
                ...
                <li><?php esc_html_e('Install', 'serenity-lite'); ?> <a target="_blank" href="<?php echo esc_url('https://wordpress.org/plugins/theme-demo-import/'); ?>"><?php esc_html_e('Theme Demo Importer', 'serenity-lite'); ?></a> <?php esc_html_e('plugin', 'serenity-lite'); ?></li>
                ...
                <li><?php esc_html_e('Install', 'serenity-lite'); ?> <a target="_blank" href="<?php echo esc_url('https://wordpress.org/plugins/defender-security/'); ?>"><?php esc_html_e('Defender WordPress Security', 'serenity-lite'); ?></a> <?php esc_html_e('plugin', 'serenity-lite'); ?></li>
            </ol>
            <p>
    ...
    <div class="right">
        <div class="upgrade">
            ...
            <p class="about-text red"><strong><?php esc_html_e('Save 15% with coupon code', 'serenity-lite'); ?> <span class="border-red"><?php esc_html_e('THEMELY15', 'serenity-lite'); ?></span></strong></p>
            <ul class="ul-square">
