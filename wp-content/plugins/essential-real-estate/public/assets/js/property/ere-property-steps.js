    ...
    var app = {
        ...
        validateForm: function(){
            ...
            var property_title = ere_property_steps_vars.property_title,
                ...
                property_status = ere_property_steps_vars.property_status,
            ...
            this.$form.validate({
                ...
                highlight: function (element, errorClass, validClass) {
                    ...
                    if (elem.hasClass("select2-hidden-accessible")) {
                        elem.parent().find('.select2-container').addClass(errorClass);
                    } else {
                ...
                unhighlight: function (element, errorClass, validClass) {
                    var elem = $(element);
                    if (elem.hasClass("select2-hidden-accessible")) {
                        elem.parent().find('.select2-container').removeClass(errorClass);
                    } else {
                ...
                rules: {
                    ...
                    'property_status[]': {
                        required: this.checkFieldRequired(property_status)
                    },
                    'property_label[]': {
